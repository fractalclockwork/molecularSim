...
void AtomMC::setrCutOff(double **newrCut)
{
  rCutOff = newrCut;
}
...
void AtomMC::setMass(double newMass)
{
  mass = newMass;
}
...
void AtomMC::setPosition(double *newPos)
{
  position = newPos;
}
...
double *AtomMC::getPosition()
{
  return position;
}

// Method: getTrialPosition
double *AtomMC::getTrialPosition()
{
